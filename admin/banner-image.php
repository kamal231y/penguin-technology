...
<body ng-app="pengu" ng-controller="banner-image-ctrl" ng-init="getData()">
		...
		<div class="content-body">
			...
			<div class="container-fluid">
				<form ng-submit="saveData()">
					<div class="row page-titles mx-0" ng-show="!tableList.length || selectImg">
						<div class="form-group col-md-3">
							<label>Image (png,jpeg,jpg) (Max size 100Kb) (Height 100px) </label>
						...
						<div class="form-group col-md-3">
							...
							<div class="input-group mb-3  mr-tp-1-per">
								<button type="submit" title="Submit" class="btn btn-info">{{btnName}}</i></button>
