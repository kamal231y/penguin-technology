...
<body ng-app="pengu" ng-controller="markets-ctrl" ng-init="getData()">
                    ...
                    <div class="row page-titles mx-0">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label>Image (png,jpeg,jpg) (1000x1000 in pixel, Max size 1MB)<sup class="mandatory">*</sup> </label>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="Title" class="form-control" ng-model="itemObject.title" placeholder="Title" maxlength="15">
                            </div>
                        </div>

                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label for="input-rounded" class="control-label">Sub Title<sup class="mandatory">*</sup> </label>
                                <input type="Title" class="form-control" ng-model="itemObject.subTitle" placeholder="Sub Title" maxlength="255">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="8" ng-model="itemObject.description" placeholder="Description" maxlength="5000"></textarea>
                            </div>
                        </div>
