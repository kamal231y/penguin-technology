				...
				<form ng-submit="saveData()" autocomplete="off">
					<div class="row page-titles mx-0">
						<div class="col-md-3 col-sm-5">
                            <div class="form-group" ng-controller="course-category-ctrl" ng-init="getData()">
						...
						<div class="form-group col-md-4">
							...
							<input type="text" class="form-control" ng-model="itemObject.title" placeholder="Enter Title" required maxlength="255">
						</div>
						<div class="form-group col-md-4">
							<label>Batch Started From</label>
							<input type="date" class="form-control" ng-model="itemObject.fromDate"> <!-- ng-model="itemObject.spec_2> -->
						</div>
						<div class="form-group col-md-4">
							<label>Course Duration</label>
							<input type="text" class="form-control" ng-model="itemObject.duration" placeholder="Course Duration exp. 4 Weeks" maxlength="10" minlength="2"> <!-- ng-model="itemObject.spec_2> -->
						</div>
						<div class="form-group col-md-4">
							<label>Ref. Video Link</label>
							<input type="url" class="form-control"  ng-model="itemObject.link" placeholder="https://www.youtube.com/watch?v=2myYG4JXW2A">
						</div>
						<!-- <div class="form-group col-md-4">
							<label>Course Amount</label>
							<input type="text" class="form-control"  ng-model="itemObject.amt" placeholder="₹ 4999" maxlength="10" minlength="3">
						</div> -->
									...
									<table class="table table-bordered table-hover">
										...
										<tbody>
											...
											<tr dir-paginate="item in tableList|itemsPerPage: itemsPerPage"
												...
												<td>
													<a type="button" data-toggle="tooltip" title="View" class="btn btn-warning  mr-1" href="view-course-detail.php?id={{item.id}}"><i class="fa fa-eye"></i></a>
