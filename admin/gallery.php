...
<body ng-app="pengu" ng-controller="gallery-ctrl" ng-init="getData()">
                ...
                <form ng-submit="saveData()" name="myForm" autocomplete="off">
                    <div class="row page-titles mx-0">
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group" ng-controller="gallerycategory-ctrl" ng-init="getData()">
                                <label for="input-rounded" class="control-label">Category<sup class="mandatory">*</sup></label>
                                <select class="form-control" id="categoryId" ng-model="$parent.itemObject.categoryId" required
                                ng-options="data.id as data.title for data in tableList">
                                    <option value="" selected disabled>Select Category</option>
                                    <!-- <option ng-value="{{data.id}}" ng-repeat="data in tableList">{{data.title}}</option> -->
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                <label>Image (png,jpeg,jpg) (500x500 in pixel, Max size 1MB)<sup class="mandatory">*</sup> </label>
                        ...
                        <div class="form-group col-md-12">
							...
							<textarea id="textareaTinymc2" class="form-control" rows="5" placeholder="Description" spellcheck="false" data-gramm="false" ng-model="itemObject.description" maxlength="2000" required></textarea>
						</div>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                             <tr dir-paginate="item in items=(tableList | filter:filterPro) | itemsPerPage: itemsPerPage" current-page='currentPage'>
                                                ...
                                                <td>{{item.title}}</td>
                                                <td class="wd-40">
                                                    <img class="wd-40" src="{{item.image_url}}" alt="">
                                                </td>
                                                <td>
