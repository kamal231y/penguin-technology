...
<body ng-app="pengu" ng-controller="add-courses-ctrl" ng-init="getSingleDataAdmin('<?= $id ?>')">
							...
							<div class="card-body">
								<div class="head_title">
									<div class="row">
										...
										<div class="col-md-6">
											<a href="add-courses.php"><button class="btn btn-warning float-right"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Back</button></a>
										</div>
									</div>
								</div>
