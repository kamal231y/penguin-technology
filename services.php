...
<head>
    <title>Penguin Technology | Services</title>
    <?php include "include/css-url.php"; ?>
</head>

<body ng-app="pengu" ng-controller="add-products-ctrl" ng-init="getData('<?=$id?>')" ng-cloak>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="smbanner-text d-flex justify-content-center align-items-center flex-column text-center">
                    <h2 class="sm-banner-title">{{tableObj.category.title}}</h2>
                    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{tableObj.category.title}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="courses-section pt-80 pb-80">
        <div class="container">
                    ...
                    <div class="course-item">
                        ...
                        <div class="course-content">
                            ...
                            <a href="details.php">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero dolorum repellendus iste nostrum quae et quibusdam nam earum...</p>
                            </a>
                            <a href="details.php" class="primary--btn course-btn">More Details</a>
                        </div>
                    </div>
                </div> -->
            </div>
